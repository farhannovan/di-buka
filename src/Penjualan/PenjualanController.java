...
public class PenjualanController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        //System.out.println(Integer.parseInt(tfJumlah.getText()));
    }    
    ...
    @FXML
    private void dpTanggal(ActionEvent event) {
    }

    @FXML
    private void tfJumlah(ActionEvent event) {
    }

    @FXML
    private void dpTempo(ActionEvent event) {
    }
        
    @FXML
    private void cbStatus(ActionEvent event) {
    }

    @FXML
    private void cbHutang(ActionEvent event) {
    }
    ...
    private void buttonSimpan(ActionEvent event) {
        ...
        if("Pengeluaran".equals(cbStatus.getSelectionModel().getSelectedItem())){
    ...
    @FXML
    private void tfAnggaran(ActionEvent event) {
    }
